...
contextBridge.exposeInMainWorld('luxshiftAPI', {
  ...
  parseSchedule: (text) => ipcRenderer.invoke('luxshift:parse-schedule', { text }),
  ...
  removeWindDownListener: (listener) => {
    ...
    ipcRenderer.removeAllListeners('luxshift:winddown-state');
  },
  ...
  removeSunlightNudgeListener: (listener) => {
    ...
    ipcRenderer.removeAllListeners('luxshift:sunlight-nudge');
  },
  getSunData
});
